...
const UnserePartner = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Section className="py-20 bg-gradient-to-br from-primary/5 via-blue-50 to-primary/10">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-gradient-primary hover:opacity-90 text-white font-semibold px-8 py-3">
