...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Section className="py-16 bg-gradient-to-br from-blue-50 via-blue-50/50 to-blue-100/30 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/8 via-transparent to-blue-800/8"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-500/8 via-transparent to-transparent"></div>
        <div className="relative z-10">
          <div className="container mx-auto px-4">
      ...
      <Section className="py-16 bg-gradient-to-br from-blue-50 via-blue-100/30 to-blue-50 relative overflow-hidden">
