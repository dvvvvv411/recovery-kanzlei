...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Team Section */}
      <Section className="py-16 bg-gradient-to-br from-white via-blue-50/20 to-gray-50 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 via-transparent to-blue-600/5"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-500/10 via-transparent to-transparent"></div>
        <div className="relative z-10">
          <div className="container mx-auto px-4">
            <SectionHeader>
              <SectionTitle className="text-3xl lg:text-4xl bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent">
                Unser Team
              </SectionTitle>
              <SectionDescription>
                Erfahrene Rechtsexperten und kompetente Unterstützung für Ihren Erfolg
              </SectionDescription>
            </SectionHeader>
              ...
              <div className="group">
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Daniel Azem</h3>
                    <p className="text-blue-600 font-medium">Rechtsanwalt</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="group">
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Anela Blöch</h3>
                    <p className="text-blue-600 font-medium">Rechtsanwältin</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="group">
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Roman Taudes</h3>
                    <p className="text-blue-600 font-medium">Rechtsanwalt</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="group">
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Patrick Brunsteiner</h3>
                    <p className="text-blue-600 font-medium">Rechtsanwaltsanwärter</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="group">
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Olja Drljevic</h3>
                    <p className="text-blue-600 font-medium">Teamassistentin</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="group">
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Nerma Hadzic</h3>
                    <p className="text-blue-600 font-medium">Teamassistentin</p>
                  </CardContent>
                </Card>
              </div>
