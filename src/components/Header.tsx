      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between max-w-6xl">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-card border-border shadow-lg text-foreground z-50 rounded-lg min-w-[200px]" style={{ boxShadow: 'var(--shadow-modern)' }}>
              <DropdownMenuItem className="hover:bg-accent focus:bg-accent hover:text-accent-foreground focus:text-accent-foreground transition-colors">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-card border-border shadow-lg text-foreground z-50 w-80 rounded-lg" style={{ boxShadow: 'var(--shadow-modern)' }}>
              <DropdownMenuItem className="hover:bg-accent focus:bg-accent hover:text-accent-foreground focus:text-accent-foreground transition-colors">
